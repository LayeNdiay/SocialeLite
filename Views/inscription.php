   ...
   <div id="container">
      ...
      if ($con === 'register') { ?>
         <form action="/SocialeLite/login" method="POST">
            ...
            <label for="phone"><b>Votre Numero</b></label>
            <input type="number" name="phone" required class="form-control">
            <input type="submit" id='submit' value='cree mon compte'>
            <p>vous avec deja un compte ?<a href="/SocialeLite/login/connection">Se Connectez</a></p>
         </form>
      <?php } else { ?>
         <form action="/SocialeLite/login" method="POST">
            ...
            <p>vous n'avez pas de compte ?<a href="/SocialeLite/login/register">Créez un compte</a></p>
         </form>
      <?php } ?>
